...
#include "MarlinApp.h"
#include "MMI/ViewStrategy.h"
#include "MMI/NullViewStrategy.h"
...
extern MarlinApp * pMarlinApp = NULL;
extern MMI::ViewStrategy* pViewStrategy = NULL;
...
{
public:
    TestProgressListener( CppUnit::CompilerOutputter* pOutputter ) :
...
#ifdef _WIN32
    HANDLE TestProgressListener::consoleHandle = INVALID_HANDLE_VALUE;
    WORD TestProgressListener::defaultConsoleAttributes = 0;
#endif
...
int main(int argc, char** argv)
{
	...
	MMI::NullViewStrategy nullViewStrategy;
	pViewStrategy = &nullViewStrategy;
    ...
    TestProgressListener gvlsListener( &compilerOutputter );
    controller.addListener( &gvlsListener );

    // Add the top suite to the test runner.
    CPPUNIT_NS::TestRunner runner;
    runner.addTest(CPPUNIT_NS::TestFactoryRegistry::getRegistry().makeTest());
    runner.run(controller);
    gvlsListener.printTestResults( resultCollector );
